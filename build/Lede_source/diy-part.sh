...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='192.168.7.5'                                    # IPv4 地址(openwrt后台地址)
uci set network.lan.netmask='255.255.255.0'                                 # IPv4 子网掩码
uci set network.lan.gateway='192.168.7.6'                                   # IPv4 网关
uci set network.lan.broadcast='192.168.7.255'                               # IPv4 广播
uci set network.lan.dns='192.168.7.6'                                       # DNS(多个DNS要用空格分开)
